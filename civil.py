...
4)To spread awareness of societal issues.
    ...
    def civil_paper(update:Update, context:CallbackContext):
        keyboard =[
                [
                    InlineKeyboardButton("Sem 1, 2", callback_data='civil_sem_1_2' ,url=""),
                ],
                [
                    InlineKeyboardButton("Sem 3", callback_data='civil_3', url=""),
                    InlineKeyboardButton("Sem 4", callback_data='civil_4',url=""),
                ],
                [
                    InlineKeyboardButton("Sem 5", callback_data='civil_5',url=""),
                    InlineKeyboardButton("Sem 6", callback_data='civil_6',url=""),
                ],
                [
                    InlineKeyboardButton("Sem 7", callback_data='civil_7',url=""),
                    InlineKeyboardButton("Sem 8", callback_data='civil_8',url=""),
                ]
