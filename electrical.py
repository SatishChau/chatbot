...
2) To cultivate graduates to be civically engaged entities who distinguish their accountability and role in their societies and the world.
    ...
    def Electrical_paper(update:Update, context:CallbackContext):
        keyboard =[
                [
                    InlineKeyboardButton("Sem 1, 2", callback_data='ele_sem_1_2' ,url=""),
                ],
                [
                    InlineKeyboardButton("Sem 3", callback_data='ele_3', url=""),
                    InlineKeyboardButton("Sem 4", callback_data='ele_4',url=""),
                ],
                [
                    InlineKeyboardButton("Sem 5", callback_data='ele_5',url=""),
                    InlineKeyboardButton("Sem 6", callback_data='ele_6',url=""),
                ],
                [
                    InlineKeyboardButton("Sem 7", callback_data='ele_7',url=""),
                    InlineKeyboardButton("Sem 8", callback_data='ele_8',url=""),
                ]
